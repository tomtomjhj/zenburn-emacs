...
;;;;; isearch
   ...
   `(lazy-highlight ((t (:background ,"#444444" :weight bold :underline t))))
   ...
   `(mode-line-inactive
     ((t (:foreground ,zenburn-green-2
                      ...
                      :box (:line-width -1 :style released-button)))))
   `(region ((,class (:background ,"#626262" :extend t))
             (t :inverse-video t)))
...
;;;;; line numbers (Emacs 26.1 and above)
   `(line-number ((t (:foreground ,zenburn-fg-1 :background ,zenburn-bg))))
